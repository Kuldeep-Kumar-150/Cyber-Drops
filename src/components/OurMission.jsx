        ...
        <section className='py-5 position-relative'>
            ...
            <Container>
                <Row className='align-items-center'>
                    <Col md={6} xl={6} className='d-flex justify-content-center justify-content-md-start' data-aos="fade-up-right">
                        <img className='card_img' src={cards} alt="balooImage" />
                    </Col>
                    <Col md={6} xl={6} className='text-center text-md-start' data-aos="fade-up-left">
